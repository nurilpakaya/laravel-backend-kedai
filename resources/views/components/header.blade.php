    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{ auth()->user()->name }}</div> <!-- Perbaikan kurung tutup -->
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <form id="logout-form" action="{{ route('logout') }}" method="POST"> <!-- Perbaikan kurung pada route logout -->
                    @csrf
                </form>
            </div>
        </li>
